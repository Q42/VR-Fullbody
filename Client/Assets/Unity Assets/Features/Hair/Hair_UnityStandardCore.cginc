...
half4 fragForwardBase (VertexOutputForwardBase i) : SV_Target
{
	...
	mainLight.ndotl = KKDiffuseApprox(s.normalWorld, mainLight.dir);
...
//begin-volund-hair: Hair shading
	...
	half4 c = ShadeHair(
		tanFlow, grayMask, vtxOcclusion, atten,
		WorldNormal(i.tangentToWorldAndParallax), half3x3(i.tangentToWorldAndParallax[0].xyz, i.tangentToWorldAndParallax[1].xyz, i.tangentToWorldAndParallax[2].xyz),
		gi.light, gi.indirect,
		s.diffColor, s.specColor, s.eyeVec, s.normalWorld, s.oneMinusReflectivity, s.oneMinusRoughness
	);

#ifdef DBG_HAIR_OCCLUSION
	return half4(vtxOcclusion, vtxOcclusion, vtxOcclusion, s.alpha);
#endif
#ifdef DBG_HAIR_GRAYMASK
	return half4(grayMask, grayMask, grayMask, s.alpha);
#endif
#ifdef DBG_HAIR_FLOW
	return half4(half3(tanFlow.x, tanFlow.y, -1.f) * 0.5 + 0.5, s.alpha);
#endif
#ifdef DBG_HAIR_MASKEDALBEDO
...
//begin-volund-hair: Hair shading
	...
	half4 c = ShadeHair(
		tanFlow, grayMask, vtxOcclusion, atten,
		WorldNormal(i.tangentToWorldAndLightDir), half3x3(i.tangentToWorldAndLightDir[0].xyz, i.tangentToWorldAndLightDir[1].xyz, i.tangentToWorldAndLightDir[2].xyz),
		light, indirect,
		s.diffColor, s.specColor, s.eyeVec, s.normalWorld, s.oneMinusReflectivity, s.oneMinusRoughness
	);
//end-volund-hair:
